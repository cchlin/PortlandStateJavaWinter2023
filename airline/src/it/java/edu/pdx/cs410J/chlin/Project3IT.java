...
//  }
  ...
  @Test
    void testWriteToFile() {
      ...
      Project3.writeToFile(file, "Invalid Airline", airline);
  ...
  @Test
    void testPretty() {
      MainMethodResult result = invokeMain(Project3.class, "Alaska Airline", "321","PDX","3/15/2023","10:36","pm","SEA","3/15/2023","11:36","PM","-print","-textfile","alaska.txt","-pretty","-");
      System.out.println(result.getTextWrittenToStandardOut());
  }

  @Test
    void testWrongAMPM() {
      assertThat(false, equalTo(Project3.isValidDateAndTime("3/15/2023 10:36 4M")));
  }

  @Test
    void testStringHasNumber() {
      assertThat(true, equalTo(Project3.hasInt("aa1cc")));
  }

    @Test
    void testMissingArg() {
        MainMethodResult result = invokeMain(Project3.class, "Alaska Airline");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** missing: flight number\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** missing: departure airport code\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "P1X");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** Departure airport code should be letters only: P1X\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** missing: departure date\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** missing: departure time\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** missing: departure am/pm marker\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "8m");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** The departure am/pm marker should not include integer: 8m\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "ampm");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** The departure am/pm marker should be 2 letters only: ampm\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** missing: arrival airport code\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm", "S1A");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** Arrival airport code should be letters only: S1A\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm", "SEA");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** missing: arrival date\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm", "SEA","3/15/2023");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** missing: arrival time\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm", "SEA","3/15/2023","11:39");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** missing: arrival am/pm marker\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm", "SEA","3/15/2023","11:39", "5m");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** The arrival am/pm marker should not include integer: 5m\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm", "SEA","3/15/2023","11:39", "pma");
    ...
    void testTooManyArgs() {
        MainMethodResult result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm", "SEA","3/15/2023","11:39", "pm", "extraArgs");
    ...
    void testBadFileName() {
      ...
      assertFalse(Project3.validFileNameFormat(badName));
    }

    @Test
    void testNonexistedAirportCode() {
        MainMethodResult result = invokeMain(Project3.class, "Alaska Airline", "25", "ZZZ", "3/15/2023", "10:36", "pm", "SEA","3/15/2023","11:39", "pm");
        assertThat(result.getTextWrittenToStandardError(), equalTo("** Source airport code does not exist: ZZZ\n"));
        result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm", "ZZZ","3/15/2023","11:39", "pm");
    ...
    void testArrivalTimeTooEarly() {
        MainMethodResult result = invokeMain(Project3.class, "Alaska Airline", "25", "PDX", "3/15/2023", "10:36", "pm", "SEA","3/15/2023","9:39", "pm");
