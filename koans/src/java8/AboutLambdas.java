...
public class AboutLambdas {
    ...
    // the functional interface is an interface with only one abstract methods,
    // and it is the basis for the lambda expression syntax
    interface Caps {
    ...
    public void methodReference() {
        ...
        // the method reference String::toUpperCase is treated as an implementation of
        // the capitalize()?
