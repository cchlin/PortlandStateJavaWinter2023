...
public class AboutInnerClasses {
    ...
    public void innerClassesInMethods() {
        ...
        // The MethodInnerClass can only be used within the innerClassesInMethods()
        // method. It has local scope and can't be accessed from outside of the method
    }
...
//        This means that static inner classes are self-contained and do not have access
//        to non-static members of the outer class.
    }
