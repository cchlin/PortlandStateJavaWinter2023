...
public class AboutInheritance {
    ...
    public void methodOverloadingUsingPolymorphism() {
        ...
        // No, they can't. Because they are referenced to Animal
        // so they can only access Animal's properties.
    }
    ...
    public void overriddenMethodsMayReturnSubtype() {
        ...
        // I changed the returned type in the subclass ChildTwo's method from
        // Collection<?> to List<?>
        // Seems like if the return type in the subclass overriding method
        // is a subtype of the return type of the superclass method, it would work
    }
}
